...
class Fondy
{
    public static $FORM_ACTION = 'https://payment.albpay.io/api/checkout/redirect/';
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, 'https://payment.albpay.io/api/checkout/url/');
...
//        }
    ...
    public function getForm()
    {
        ...
        $payment_forma .= PHPShopText::setInput('submit', 'send', 'Alliance bank', $float = "left; margin-left:10px;", 250);
